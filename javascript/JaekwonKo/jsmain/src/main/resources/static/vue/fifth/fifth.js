        ...
        myDarknessDragon () {
         ...
         yourDarknessDragon () {
            if (!(this.characterStatus.selectJob === '모험가') && !(this.firstFormerStat)) {
                this.monsters[i].hp = 
                    parseInt(this.monsters[i].hp - ((this.characterStatus.str) +(this.characterStatus.int) + 
                    (this.characterStatus.dex) + (this.characterStatus.vit) + ( this.characterStatus.men) * 3.5))
