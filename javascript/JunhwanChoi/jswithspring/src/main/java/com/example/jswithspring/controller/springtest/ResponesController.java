...
public class ResponesController {
    ...
    public Member jsonMember () throws Exception {
        log.info("jsonMember() ");
    ...
    public List<Member> jsonListMember() throws Exception {
    ...
    public Map<String, Member> jsonHashMapMember() throws Exception {
