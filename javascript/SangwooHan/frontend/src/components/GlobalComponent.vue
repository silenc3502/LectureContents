...
export default {
    ...
    // 컴포넌트의 이름을 작성한다.
    // 보편적으로 Letsgo라면 Lets-go 같은 형태로 이름을 작성한다 
    // 마찬가지로 java의 명명법 같은 형식이라 생각하면 되겠다.
    // 문법이 관습적인 명명법을 따르는 것들이 있으므로 되도록 지켜주자.!
    name: 'global-component',
    props: ['initialTest'],

    // template의 경우엔 컴포넌트를 배치했을때 자동으로 생성되는 HTML 태그를 의미한다.
