var app = new Vue ({
    ...
    methods: {
        ...
        selectJob () {
            switch (this.characterStatus.selectJob) {
                    ...
                    this.characterStatus.intelligence += 10
    ...
    beforeUpdate() {
        ...
        for (; this.characterStatus.currentLevelBar >= this.characterStatus.totalLevelBar; ) {
            if (this.characterStatus.level < 51) {
                console.log("1~50 레벨 스텟 상승치 적용")
            ...
            this.characterStatus.men *= 1.1
                    ...
                    console.log("51~100 레벨 스텟 상승치 적용")
                    this.characterStatus.currentLevelBar =
                        parseInt(this.characterStatus.currentLevelBar -
                            this.characterStatus.totalLevelBar)
                    this.characterStatus.level += 1
                    this.characterStatus.hp *= 2.4
                    this.characterStatus.defaultAtk += 6
                    this.characterStatus.atk += 6
                    this.characterStatus.def += 2
                    this.characterStatus.str *= 2.2
                    this.characterStatus.intelligence *= 2.2
                    this.characterStatus.dex *= 2.2
                    this.characterStatus.vit *= 2.2
                    this.characterStatus.def *= 2.2
                    this.characterStatus.men *= 2.2
                }
